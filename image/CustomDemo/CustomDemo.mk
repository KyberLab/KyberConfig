...
define image_custom_fetch
	$(IQ)$(call xprint_title,	"Image $(IMAGE_BUILD_GOAL) Fetch",$(BG_YELLOW))
...
define image_custom_patch
	$(IQ)$(call xprint_title,	"Image $(IMAGE_BUILD_GOAL) Patch",$(BG_YELLOW))
	$(IQ)$(call xprint_value,	"Patch Options",	$(1),$($(BG_PURPLE)))
	$(IQ)$(call xprint_value,	"Config Path",		$(2),$($(BG_PURPLE)))
	$(IQ)$(call xprint_value,	"Build Path",		$(3),$($(BG_PURPLE)))
	$(IQ)$(call xprint_value,	"Install Path",		$(4),$($(BG_PURPLE)))
	$(IQ)$(call xprint_value,	"Patch Files",		$(wildcard $(2)/Patches/*.patch),$($(BG_PURPLE)))
	$(IQ)$(call xprint_line,$(BG_YELLOW))
endef
...
define image_custom_package
	$(IQ)$(call xprint_title,	"Image $(IMAGE_BUILD_GOAL) Package",$(BG_YELLOW))
	$(IQ)$(call xprint_value,	"Package Options",	$(1),$($(BG_PURPLE)))
	$(IQ)$(call xprint_value,	"Config Path",		$(2),$($(BG_PURPLE)))
	$(IQ)$(call xprint_value,	"Build Path",		$(3),$($(BG_PURPLE)))
	$(IQ)$(call xprint_value,	"Install Path",		$(4),$($(BG_PURPLE)))
	$(IQ)$(call xprint_value,	"Package List",		$(5),$($(BG_PURPLE)))
	$(IQ)$(call xprint_line,$(BG_YELLOW))
endef
